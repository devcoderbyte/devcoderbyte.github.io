...
<div class="container" id="work" style="padding-top:3rem;padding-bottom:1rem">
  ...
  <div class="tool-banner">
    <div class="tool-banner-left">
      <span class="tool-banner-icon">🎯</span>
      <div class="tool-banner-text"><strong>More interactive tools</strong> — Toil Audit Scorecard and RFQ Complexity Scorer now live.</div>
    </div>
    <a href="/tools/" class="tool-banner-cta">View all tools →</a>
  </div>
</div>
