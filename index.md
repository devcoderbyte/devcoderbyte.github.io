...
<div class="hero">
  <div class="container">
    ...
    <div class="hero-links">
      ...
      <a href="/delivery-pulse/now/" class="btn btn-ghost">What I'm doing now →</a>
    </div>
    ...
    <div class="domain-grid">
      <a class="domain-card" href="/delivery-pulse/ai-in-delivery/">
      ...
      <a class="domain-card" href="/delivery-pulse/presales-practice/">
        <div class="domain-icon">🎯</div>
      ...
      <a class="domain-card" href="/delivery-pulse/sre-observability/">
        <div class="domain-icon">📊</div>
      ...
      <a class="domain-card" href="/delivery-pulse/delivery-governance/">
        <div class="domain-icon">📋</div>
      ...
      <a class="domain-card" href="/delivery-pulse/case-studies/">
        <div class="domain-icon">🏆</div>
      ...
      <a class="domain-card" href="/delivery-pulse/tool-proficiency/">
